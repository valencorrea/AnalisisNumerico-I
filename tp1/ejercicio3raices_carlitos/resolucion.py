...
biseccion1 = bi.raiz(f1, 0, 2*4.25, 1e-13, 12)
biseccion2 = bi.raiz(f2, 0, 2*4.25, 1e-13, 12)
...
#pfijo1 = pf.raiz(f1, 0, 1e-13, 12)
#pfijo2 = pf.raiz(f2, 0, 1e-13, 12)
...
nr1 = nr.raiz(f1, analisis.derivada, 1e-12, 2*4.25 - 1e-12, 1e-13, 12) #lo corro un poco ya que derivada en extremos se anula
nr2 = nr.raiz(f2, analisis.derivada, 1e-12, 2*4.25, 1e-13, 12)
...
secante1 = se.raiz(f1, 0, 2*4.25, 1e-13, 12)
secante2 = se.raiz(f2, 0, 2*4.25, 1e-13, 12)
...
nr_modificado1 = nrm.raiz(f1, analisis.derivada, analisis.derivada_segunda, 1e-12, 2*4.25 - 1e-12, 1e-13, 12)
nr_modificado2 = nrm.raiz(f2, analisis.derivada, analisis.derivada_segunda, 1e-12, 2*4.25 - 1e-12, 1e-13, 12)
