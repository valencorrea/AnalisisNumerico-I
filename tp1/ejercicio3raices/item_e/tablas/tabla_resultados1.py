...
biseccion = {'Raices': biseccion1[0][0:49], 'Cotas': biseccion1[1][0:49], 'Orden de convergencia': ordenb1,'constante asintotica' : c1.lambda_b1[0:49] }
secante = {'Raices': secante1[0][2:8], 'Cotas': secante1[1][2:8], 'Orden de convergencia': orden_secante1,'constante asintotica' : c1.lambda_secante1[0:6]}
nr = {'Raices': nr1[0][2:6], 'Cotas': nr1[1][2:6], 'Orden de convergencia': orden_nr1,'constante asintotica' : c1.lambda_nr1[0:4]}
nr_mod = {'Raices': nr_modificado1[0][2:6], 'Cotas': nr_modificado1[1][2:6], 'Orden de convergencia': orden_nr_modificado1,'constante asintotica' : c1.lambda_nr_modificado1[0:4]}

print(len(biseccion1[0]), len(c1.lambda_b1))
