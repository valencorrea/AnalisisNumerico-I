...
import ejercicio3raices.item_e.constantes_asintoticas.constante_f2 as c2
import pandas as pd

biseccion = {'Raices': biseccion2[0][0:26], 'Cotas': biseccion2[1][0:26], 'Orden de convergencia': ordenb2,'constante asintotica' : [c2.lambda_b2]* 26}
secante = {'Raices': secante2[0], 'Cotas': secante2[1], 'Orden de convergencia': orden_secante2,'constante asintotica' : [c2.lambda_secante2]*2}
nr = {'Raices': nr2[0][2:26], 'Cotas': nr2[1][2:26], 'Orden de convergencia': orden_nr2,'constante asintotica' : [c2.lambda_nr2]* 24}
nr_mod = {'Raices': nr_modificado2[0][2:5], 'Cotas': nr_modificado2[1][2:5], 'Orden de convergencia': orden_nr_modificado2,'constante asintotica' : [c2.lambda_nr_modificado2] * 3}

print(len(nr_modificado2[0]), len(orden_nr_modificado2))
